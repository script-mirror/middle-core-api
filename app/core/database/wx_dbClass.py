...
class db_mysql_master():
    ...
    def __init__(self, dbase):
        __host_mysql = settings.host_mysql
        __port_mysql = settings.port_mysql

        __user_mysql = settings.user_mysql
        __password_mysql = settings.password_mysql

        self.meta = db.MetaData()
        self.user = __user_mysql
        self.password = __password_mysql
        self.host = __host_mysql
        self.port = __port_mysql
        self.dbase = dbase

        self.engine = db.create_engine(
            f"mysql+pymysql://{self.user}:{self.password}@{self.host}:{self.port}/{dbase}", pool_pre_ping=True)
    ...
    def db_execute(self, query, commit: bool = True, debug: str = None):
        ...
        try:
            ...
            if commit:
                session.rollback()
            send_message(
                f"Error executing query: {str(e.orig)}\nQuery: {str(query)}\n{debug}", file=None, dest="debug")
    ...
    def getSchema(self, table_name: str) -> db.Table:
        ...
        if table_name.lower() == 'tb_cadastro_rodadas':
            ...
            table_schema = db.Table('tb_negociacoes', self.meta,
                                    ...
                                    db.Column('id_categoria_negociacao', db.ForeignKey(
                                        'bbce.tb_categoria_negociacao.id'))
                                    )
            ...
            table_schema = db.Table('tb_processos_aneel', self.meta,
                                    ...
                                    db.Column(
                                        "str_ultimo_documento_enviado", db.String(70)),
                                    db.Column("str_relator", db.String(70)),
                                    db.Column("str_superintendencia",
                                              db.String(70))
                                    )
            ...
            table_schema = db.Table('tb_pld', self.meta,
                                    db.Column('str_ano', db.SMALLINT,
                                              nullable=False),
                                    db.Column('vl_PLDmax_hora',
                                              db.FLOAT, nullable=False),
                                    db.Column('vl_PLDmax_estr',
                                              db.FLOAT, nullable=False),
                                    db.Column('vl_PLDmin', db.FLOAT,
                                              nullable=False),
                                    db.Column('vl_custo_Deficit',
                                              db.FLOAT, nullable=False)
                                    )
            ...
            table_schema = db.Table('tb_intercambio_dessem', self.meta,
                                    ...
                                    db.Column('str_nomeRE', db.String(
                                        250), primary_key=True, nullable=False),
                                    db.Column('dt_data_hora', db.DATETIME,
                                              primary_key=True, nullable=False),
                                    db.Column(
                                        'vl_limite_inferior', db.INTEGER),
                                    db.Column(
                                        'vl_limite_utilizado', db.INTEGER),
                                    db.Column(
                                        'vl_limite_superior', db.INTEGER),
                                    db.PrimaryKeyConstraint(
                                        'str_nomeRE', 'dt_data_hora'),
                                    )
            ...
            table_schema = db.Table('tb_balanco_dessem', self.meta,
                                    db.Column('dt_data_hora', db.DATETIME,
                                              primary_key=True, nullable=False),
                                    db.Column('str_subsistema', db.String(
                                        2), primary_key=True, nullable=False),
                                    db.Column('vl_cmo', db.FLOAT),
                                    db.Column('vl_demanda', db.FLOAT),
                                    db.Column(
                                        'vl_geracao_renovaveis', db.FLOAT),
                                    db.Column(
                                        'vl_geracao_hidreletrica', db.FLOAT),
            ...
            table_schema = db.Table('tb_submercado', self.meta,
                                    db.Column('cd_submercado',
                                              db.Integer, primary_key=True),
                                    db.Column('str_submercado',
                                              db.VARCHAR(100)),
            ...
            table_schema = db.Table('tb_dc_dadger_pq', self.meta,
                                    db.Column("id_deck", db.Integer,
                                              primary_key=True, nullable=False),
                                    db.Column("vl_estagio",
                                              db.Integer, nullable=False),
                                    db.Column("vl_patamar",
                                              db.Integer, nullable=False),
                                    db.Column("cd_submercado",
                                              db.Integer, nullable=False),
            ...
            table_schema = db.Table('tb_pluvia_ena', self.meta,
                                    db.Column('ID_RODADA', db.Integer,
                                              primary_key=True),
                                    db.Column('CD_BACIA', db.Integer,
                                              nullable=False),
                                    db.Column('VL_ENA', db.Float,
                                              nullable=False),
                                    db.Column('VL_ENA_PERC_MLT',
                                              db.Float, nullable=False),
                                    db.Column('DT_REFERENTE', db.Date),
                                    ...
                                    db.Column('FL_VIES', db.Boolean,
                                              default=False),
                                    db.Column('FL_PRELIMINAR',
            ...
            table_schema = db.Table('tb_ree', self.meta,
                                    db.Column(
                                        'cd_ree', db.SmallInteger, primary_key=True),
            ...
            table_schema = db.Table('tb_rdh_submercado', self.meta,
                                    ...
                                    db.Column(
                                        'vl_media_semana_queda', db.Float),
                                    db.Column('dt_referente', db.DateTime)
                                    )
            ...
            table_schema = db.Table('tb_nw_sist_intercambio', self.meta,
                                    ...
                                    db.Column('cd_submerc_src',
                                              db.SmallInteger),
                                    db.Column('cd_submerc_dst',
                                              db.SmallInteger),
                                    db.Column('vl_intercambio', db.Float),
            ...
            table_schema = db.Table('tb_ds_renovaveis', self.meta,
                                    db.Column('id_deck', db.Integer),
                                    db.Column('vl_periodo',
                                              db.Integer, nullable=False),
                                    db.Column('id_submercado',
                                              db.Integer, nullable=False),
        ...
        # db_meteorologia
            ...
            table_schema = db.Table('tb_estado', self.meta,
                                    ...
                                    db.Column('id_submercado', db.ForeignKey(
                                        'db_ons.tb_submercado.cd_submercado')),
                                    extend_existing=True
                                    )
        elif table_name.lower() == 'tb_restricoes_coff_eolica':

            table_schema = db.Table('tb_restricoes_coff_eolica', self.meta,
                                    db.Column('id_estado', db.ForeignKey(
                                        'db_ons_dados_abertos.tb_estado.id_estado'), primary_key=True),
                                    db.Column('dt_data_hora',
                                              db.DateTime, primary_key=True),
                                    db.Column('cd_razao_restricao',
                                    ...
                                    db.Column(
                                        'vl_geracao_referencia', db.Float),
                                    db.Column(
                                        'vl_geracao_referencia_final', db.Float),
                                    extend_existing=True
                                    )
            ...
            table_schema = db.Table('tb_posto_uhe', self.meta,
                                    db.Column(
                                        'cd_uhe', db.SmallInteger, nullable=True),
                                    db.Column(
                                        'cd_posto', db.SmallInteger, nullable=True),
                                    db.Column('cd_np', db.String(
                                        10), nullable=True),
                                    db.Column('str_usina', db.String(
                                        255), nullable=True),
                                    db.Column('cd_submercado',
            ...
            table_schema = db.Table('tb_carga', self.meta,
                                    db.Column('id_subsistema', db.ForeignKey(
                                        'db_ons.tb_submercado.cd_submercado'), primary_key=True),
                                    db.Column('dt_data_hora',
                                              db.DateTime, primary_key=True),
                                    db.Column('vl_carga_global', db.Float),
                                    db.Column(
                                        'vl_carga_global_cons', db.Float),
                                    db.Column(
                                        'vl_carga_global_smmgd', db.Float),
                                    db.Column(
                                        'vl_carga_supervisionada', db.Float),
                                    db.Column(
                                        'vl_carga_nao_supervisionada', db.Float),
            ...
            table_schema = db.Table('tb_carga_programada', self.meta,
                                    ...
                                    db.Column('dt_data_hora',
                                              db.DateTime, primary_key=True),
                                    db.Column(
                                        'vl_carga_global_programada', db.Float),
                                    extend_existing=True
                                    )
            ...
            table_schema = db.Table('tb_negociacoes_resumo', self.meta,
                                    db.Column('id_produto', db.ForeignKey(
                                        'bbce.tb_produtos.id_produto'), primary_key=True),
                                    db.Column('data', db.DateTime,
                                              primary_key=True),
            ...
            table_schema = db.Table('tb_pesos_grupos_ecmwf', self.meta,
                                    db.Column('id_deck', db.String(
                                        100), nullable=True),
                                    db.Column('vl_peso_g1', db.Float,
                                              nullable=False),
                                    db.Column('vl_peso_g2', db.Float,
                                              nullable=False),
                                    db.Column('vl_peso_g3', db.Float,
                                              nullable=False),
                                    db.Column('vl_peso_g4', db.Float,
                                              nullable=False),
                                    db.Column('vl_peso_g5', db.Float,
                                              nullable=False),
                                    db.Column('vl_peso_g6', db.Float,
                                              nullable=False),
                                    db.Column('vl_peso_g7', db.Float,
                                              nullable=False),
                                    db.Column('vl_peso_g8', db.Float,
                                              nullable=False),
                                    db.Column('vl_peso_g9', db.Float,
                                              nullable=False),
                                    db.Column('vl_peso_g10',
                                              db.Float, nullable=False)
                                    )
            ...
            table_schema = db.Table('tb_geracao_horaria', self.meta,
                                    ...
                                    db.Column('dt_referente',
                                              db.DateTime, nullable=False),
                                    db.Column('vl_carga', db.Float,
                                              nullable=True),
                                    db.Column('cd_geracao',
                                              db.Integer, nullable=False),
                                    db.Column(
                                        'dt_update', db.DateTime, nullable=True),
                                    db.Column('fl_excluir',
            ...
            table_schema = db.Table('tb_regressoes', self.meta,
                                    db.Column('cd_posto_regredido',
                                              db.SmallInteger, nullable=False),
                                    db.Column('cd_posto_base',
                                              db.SmallInteger, nullable=False),
                                    db.Column(
                                        'vl_mes', db.SmallInteger, nullable=False),
                                    db.Column('vl_A0', db.Float,
                                              nullable=False),
                                    db.Column('vl_A1', db.Float,
                                              nullable=False)
                                    )
            ...
            table_schema = db.Table('tb_tipo_geracao', self.meta,
                                    db.Column('cd_geracao',
                                              db.Integer, nullable=False),
                                    db.Column('str_geracao', db.String(
                                        20), nullable=True)
                                    )
            ...
            table_schema = db.Table('tb_produtibilidade', self.meta,
                                    db.Column(
                                        'cd_posto', db.SmallInteger, nullable=False),
                                    db.Column('str_posto', db.String(
                                        50), nullable=True),
                                    db.Column('vl_produtibilidade',
                                    ...
                                    db.Column('str_sigla', db.String(
                                        2), nullable=True),
                                    db.Column(
                                        'cd_bacia', db.SmallInteger, nullable=True),
                                    db.Column('str_bacia', db.String(
                                        25), nullable=True),
                                    db.Column(
                                        'cd_ree', db.SmallInteger, nullable=True),
                                    db.Column('str_ree', db.String(
                                        25), nullable=True)
                                    )
            ...
            table_schema = db.Table('tb_fsarh', self.meta,
                                    db.Column('id', db.Integer,
                                              primary_key=True),
                                    db.Column('modified', db.DateTime,
                                              nullable=False),
                                    db.Column('temporalidade_restricao',
                                              db.String(255), nullable=True),
                                    db.Column('agente', db.String(
                                        255), nullable=True),
                                    db.Column('bacia', db.String(
                                        255), nullable=True),
                                    db.Column('rio', db.String(
                                        255), nullable=True),
                                    db.Column('reservatorio_relacionado',
                                              db.String(255), nullable=True),
                                    db.Column('restricoes_montante',
                                              db.String(255), nullable=True),
                                    db.Column('restricoes_jusante',
                                              db.String(255), nullable=True),
                                    db.Column('caracteristica_restricao',
                                              db.String(255), nullable=True),
                                    db.Column('classe_restricao',
                                              db.String(255), nullable=True),
                                    db.Column('novo_valor', db.Float,
                                              nullable=True),
                                    db.Column('valor_vigente',
                                              db.Float, nullable=True),
                                    db.Column('wfaprov', db.String(
                                        1024), nullable=True),
                                    db.Column('evento', db.String(
                                        1024), nullable=True),
                                    db.Column('justificativa',
                                              db.Text, nullable=True),
                                    db.Column('status', db.String(
                                        255), nullable=True),
                                    db.Column('reperm', db.String(
                                        1024), nullable=True),
                                    db.Column('caracteristica_restricao_ponto_cont',
                                              db.Text, nullable=True),
                                    db.Column('data_fim', db.DateTime,
                                              nullable=True),
                                    db.Column(
                                        'data_inic', db.DateTime, nullable=True)
                                    )
            ...
            table_schema = db.Table('tb_intervencoes', self.meta,
                                    db.Column('id', db.Integer,
                                              primary_key=True),
                                    db.Column('num_interv', db.String(
                                        255), nullable=True),
                                    db.Column('estado_interv', db.String(
                                        255), nullable=True),
                                    db.Column('nome_equipamento',
                                              db.String(255), nullable=True),
                                    db.Column('orgao_solic', db.String(
                                        255), nullable=True),
                                    db.Column('data_inicio',
                                              db.DateTime, nullable=False),
                                    db.Column('data_fim', db.DateTime,
                                              nullable=False),
                                    db.Column('periodo', db.String(
                                        255), nullable=True),
                                    db.Column('nome_categ', db.String(
                                        255), nullable=True),
                                    db.Column('tipo', db.Integer,
                                              nullable=False),
                                    db.Column('nome_natureza', db.String(
                                        255), nullable=True),
                                    db.Column('risco_postergacao',
                                              db.String(255), nullable=True),
                                    db.Column('recomendacao',
                                              db.Text, nullable=True)
                                    )
            ...
            table_schema = db.Table('tb_chuva_membro', self.meta,
                                    db.Column('id_membro_modelo', db.ForeignKey(
                                        'db_rodadas.tb_membro_modelo.id'), primary_key=True),
                                    db.Column('cd_subbacia', db.ForeignKey(
                                        'db_rodadas.tb_subbacia.cd_subbacia'), primary_key=True),
                                    db.Column('dt_prevista', db.Date,
                                              primary_key=True),
                                    db.Column('vl_chuva', db.Float),
                                    )
            ...
            table_schema = db.Table('tb_cadastro_estacao_chuvosa', self.meta,
                                    ...
                                    db.Column('dt_rodada', db.Date,
                                              nullable=True),
                                    db.Column('hr_rodada', db.Integer,
                                              nullable=True),
                                    db.Column('str_modelo', db.String(
                                        255), nullable=True),
                                    )
            ...
            table_schema = db.Table('tb_chuva_prevista_estacao_chuvosa', self.meta,
                                    db.Column('id_cadastro',
                                              db.Integer, primary_key=True),
                                    db.Column('dt_prevista', db.Date,
                                              nullable=True),
                                    db.Column('vl_chuva', db.String(
                                        255), nullable=True),
            ...
            table_schema = db.Table('tb_climatologia_bacias_merge', self.meta,
                                    db.Column('str_bacia', db.Text,
                                              nullable=True),
                                    db.Column('time', db.Date, nullable=True),
                                    db.Column('climatologia',
                                              db.Float, nullable=True),
            ...
            table_schema = db.Table('tb_valores_vento_previsto', self.meta,
                                    db.Column('id_cadastro', db.ForeignKey(
                                        'tb_cadastro_vento_previsto.id', ondelete='CASCADE'), nullable=True),
                                    db.Column('dt_prevista', db.Date,
                                              nullable=True),
                                    db.Column('vl_vento', db.Float,
                                              nullable=True),
                                    db.Column('estado', db.String(
                                        255), nullable=True),
                                    db.Column('aglomerado', db.String(
                                        255), nullable=True),
                                    extend_existing=True
                                    )
            ...
            table_schema = db.Table('tb_cmo_semanal', self.meta,
                                    ...
                                    db.Column('vl_media_semanal',
                                              db.Float, nullable=True),
                                    db.Column('vl_cmo_leve',
                                              db.Float, nullable=True),
                                    db.Column('vl_cmo_media',
                                              db.Float, nullable=True),
                                    db.Column('vl_cmo_pesada',
                                              db.Float, nullable=True),
                                    extend_existing=True
                                    )
            ...
            table_schema = db.Table('tb_produtos_interesse', self.meta,
                                    db.Column('id_produto', db.ForeignKey(
                                        'bbce.tb_produtos_interesse.id_produto'), primary_key=True),
            ...
            table_schema = db.Table('products', self.meta,
                                    ...
                                    db.Column('name', db.String(
                                        80), nullable=True),
                                    db.Column('last_received', db.String(
                                        80), nullable=True),
            ...
            table_schema = db.Table('tb_restricao_eletrica', self.meta,
                                    db.Column("mes_referencia", db.String(
                                        6), primary_key=True, nullable=False),
                                    db.Column("cd_re", db.Integer,
                                              primary_key=True, nullable=False),
                                    db.Column("limite", db.String(
                                        100), nullable=True),
                                    extend_existing=True
                                    )
            ...
            table_schema = db.Table('tb_restricao_eletrica', self.meta,
                                    ...
                                    db.Column("limite", db.String(
                                        100), nullable=True),
                                    db.Column("primeiro_mes_pesada",
                                              db.Float, nullable=True),
                                    db.Column("primeiro_mes_media",
                                              db.Float, nullable=True),
                                    db.Column("primeiro_mes_leve",
                                              db.Float, nullable=True),
                                    db.Column("segundo_mes_pesada",
                                              db.Float, nullable=True),
                                    db.Column("segundo_mes_media",
                                              db.Float, nullable=True),
                                    db.Column("segundo_mes_leve",
                                              db.Float, nullable=True),
                                    extend_existing=True
                                    )
            ...
            table_schema = db.Table('ena_acomph', self.meta,
                                    ...
                                    db.Column('granularidade', db.String(
                                        20), nullable=False),
                                    db.Column('localizacao', db.String(
                                        50), nullable=True),
                                    db.Column('ena', db.Float, nullable=True),
                                    db.Index('idx_granularidade',
                                             'granularidade'),
                                    db.Index('idx_data_granularidade',
                                             'data', 'granularidade'),
                                    extend_existing=True
                                    )
            ...
            table_schema = db.Table('carga_semanal_dc', self.meta,
                                    db.Column(
                                        'id', db.Integer, primary_key=True, autoincrement=True),
                                    db.Column('data_produto',
                                              db.Date, nullable=True),
                                    db.Column('semana_operativa',
                                              db.Date, nullable=True),
                                    db.Column('patamar', db.String(
                                        10), nullable=True),
                                    db.Column('duracao', db.Float,
                                              nullable=True),
                                    db.Column('submercado', db.String(
                                        5), nullable=True),
                                    db.Column('carga', db.Numeric(
                                        10, 2), nullable=True),
                                    db.Column('base_cgh', db.Numeric(
                                        10, 4), nullable=True),
                                    db.Column('base_eol', db.Numeric(
                                        10, 4), nullable=True),
                                    db.Column('base_ufv', db.Numeric(
                                        12, 7), nullable=True),
                                    db.Column('base_ute', db.Numeric(
                                        10, 4), nullable=True),
                                    db.Column('carga_mmgd', db.Float,
                                              nullable=True),
                                    db.Column('exp_cgh', db.Numeric(
                                        10, 4), nullable=True),
                                    db.Column('exp_eol', db.Numeric(
                                        10, 4), nullable=True),
                                    db.Column('exp_ufv', db.Numeric(
                                        12, 6), nullable=True),
                                    db.Column('exp_ute', db.Numeric(
                                        10, 4), nullable=True),
                                    db.Column(
                                        'estagio', db.SmallInteger, nullable=True),
                                    extend_existing=True
                                    )
            ...
            table_schema = db.Table('carga_consolidada_pmo', self.meta,
                                    ...
                                    db.Column('mes', db.Integer,
                                              nullable=False),
                                    db.Column('revisao', db.String(
                                        10), nullable=False),
                                    db.Column('subsistema', db.String(
                                        4), nullable=False),
                                    db.Column('semana', db.Integer),
                                    db.Column('dt_inicio', db.Date,
                                              nullable=False),
                                    db.Column('tipo', db.String(
                                        7), nullable=False),
                                    db.Column(
                                        'periodicidade_inicial', db.DateTime),
                                    db.Column('periodicidade_final',
                                              db.DateTime),
            ...
            table_schema = db.Table('check_cvu', self.meta,
                                    db.Column(
                                        'id', db.Integer, primary_key=True, autoincrement=True),
                                    db.Column('tipo_cvu', db.String(
                                        50), nullable=True),
                                    db.Column('data_atualizacao',
                                              db.DateTime, nullable=True),
                                    db.Column('status', db.String(
                                        50), nullable=True),
                                    db.Column('created_at', db.DateTime,
